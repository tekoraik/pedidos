...
class CategoriaComponent extends CApplicationComponent
{
    ...
    function getWidthItem($aCategorias, $nAdd = 0) { return round(1000 / ($this->_countRoots($aCategorias) + $nAdd)); }
    ...
    private function _createItem($oCategoria, $nItems = 6) {
        ...
        $aItem["url"]["htmlOptions"] = array( "style" => "width: " . round(1000 / $nItems) . "px;");
